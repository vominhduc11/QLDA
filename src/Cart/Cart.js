...
export default function Cart() {
  ...
  function DeleteProductCart(Id) {
    axios
      .delete(
        `http://localhost:8080/api/deleteProduct_Cart/${Id}/${
        ...
        <Container className="bg-white p-4" style={{ width: 1200 }}>
          ...
          {(sessionStorage.getItem("cart") === null ||
            ...
            <div className="text-center">
              ...
              <Link
                to="/"
                className="border-0 fs-4 py-2 px-4 mt-5 btn btn-danger text-white"
              >
                Tiếp tục mua sắm
              </Link>
            </div>
              ...
              <Row>
                    ...
                    <tbody>
                      {product_cart.map((item) => (
                        <tr>
                          ...
                          <td className="text-center text-danger fw-semibold">
                            <NumericFormat
                              value={item.Reduced_price * item.quantity}
                              displayType={"text"}
                              thousandSeparator={"."}
                              decimalSeparator={","}
                            />
                ...
                <Col md={3}>
                  ...
                  >
                    ...
                    <div
                      className="d-flex justify-content-between py-3 mt-4"
                      ...
                      <span className="text-danger fw-semibold">
                        <NumericFormat
                          value={JSON.parse(
                            ...
                            (total, init) =>
                              total + init.Reduced_price * init.quantity,
                            0
                          )}
                          displayType={"text"}
                          thousandSeparator={"."}
                    ...
                    <Link
                      to="/Pay"
                      className="border-0 w-100 fs-4 py-2 mt-4 btn btn-danger"
                    >
                      Thanh toán
                    </Link>
                  </div>

...
export default function Outstanding_products() {
    ...
    // gọi api
    useEffect(() => {
        axios.get("http://localhost:8080/api/getAllOutstanding_products")
        ...
        <div>
            <div className="bg-white py-3">
                <Container style={{ width: 1200 }} className="d-flex align-items-center">
                    ...
                    <span className="mt-1" style={{ color: '#f72c0f' }}>Sản phẩm nổi bật</span>
                </Container>
            </div>
            <div className="pt-4">
